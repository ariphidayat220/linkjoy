...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.bazle.vpn_connection_detector.VpnConnectionDetectorPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin vpn_connection_detector, com.bazle.vpn_connection_detector.VpnConnectionDetectorPlugin", e);
    }
    try {
