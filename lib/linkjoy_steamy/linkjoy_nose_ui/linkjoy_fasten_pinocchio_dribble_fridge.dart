...
class LinkjoyFastenPinocchioDribbleFridge extends StatefulWidget {
  final double width;
  final double height;
  final bool autoStart;

  const LinkjoyFastenPinocchioDribbleFridge({
    super.key,
    required this.width,
...
class _ImageFrameAnimationWidgetState
    extends State<LinkjoyFastenPinocchioDribbleFridge>
  ...
  Widget loadImage(String imageUrl, double width, double height) {
    return imageUrl.startsWith("http")
        ...
        : LinkjoyFasten.asset(imageUrl, width: width, height: height);
  }
