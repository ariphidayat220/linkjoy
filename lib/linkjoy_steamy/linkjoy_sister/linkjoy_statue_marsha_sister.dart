...
class LinkjoyStatueMarshaSister {
        ...
        for (
          ...
          switch (TTRichTextAtParamType.values[i]) {
            case TTRichTextAtParamType.TTRichTextAtParamTypeType:
              int atTypeIndex = LinkjoyGnomeSister.stringToInt(configStr) ?? 0;
        ...
        if (atType == TTRichTextAtType.TTRichTextAtTypeAll) {
          atTextsList.add(
            TextSpan(
              ...
              style: TextStyle(
                fontSize: style.fontSize,
                color: atColor ?? const Color(0xFF333333),
          ...
          if (isPerson &&
              ...
              LinkjoyGnomeSister.stringToInt(targetID) == LINKJOY.uid()) {
            atString = "@你";
          }
          if (showSpace) {
            atString += ' ';
  ...
  static List<InlineSpan> formatSearchTextInText(
    ...
    if (LinkjoyGnomeSister.isEmptyString(searchText) ||
  ...
  static List<dynamic> matchEmojiText(String text, {TextStyle? style}) {
    ...
    for (Match m in matches) {
      ...
      LinkjoyGnomeSister.nullSafe<RegExpMatch>(
        ...
        notNullBlock: (expMatch) {
          if (RegExp(kEmojiIconRegular).hasMatch(match)) {
            ...
            if (LinkjoyAncestorMarcoSister.instance.dic[emojiName] != null) {
              emojiIconPath =
                  LinkjoyAncestorMarcoSister.instance.basePath +
                  LinkjoyAncestorMarcoSister.instance.dic[emojiName]!.icon!;
            }
