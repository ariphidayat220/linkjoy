...
@DataClassName("linkjoy_unborn_cite")
class LinkjoyUnbornCite extends Table {
  ...
  TextColumn get country_flag => text().nullable()();

  TextColumn get country_name => text().nullable()();
