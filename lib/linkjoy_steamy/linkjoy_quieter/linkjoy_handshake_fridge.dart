...
class LinkjoyHandshakeFridge extends StatefulWidget {
  final Widget child;
  ...
  final LinkjoyHandshakeMario? controller;

  const LinkjoyHandshakeFridge({
    super.key,
    required this.child,
    this.minScale = 0.9,
    this.maxScale = 1.0,
  ...
  @override
  _LinkjoyHandshakeFridgeStatus createState() =>
      _LinkjoyHandshakeFridgeStatus();
}

class _LinkjoyHandshakeFridgeStatus extends State<LinkjoyHandshakeFridge>
  ...
  @override
  void didUpdateWidget(covariant LinkjoyHandshakeFridge oldWidget) {
