...
class LinkjoyOhioDivisionAlphabet extends StatefulWidget {
  const LinkjoyOhioDivisionAlphabet({
    super.key,
    this.navigationBar,
  ...
  @override
  _LinkjoyOhioDivisionAlphabetStatus createState() =>
      _LinkjoyOhioDivisionAlphabetStatus();
}

class _LinkjoyOhioDivisionAlphabetStatus
    extends State<LinkjoyOhioDivisionAlphabet> {
