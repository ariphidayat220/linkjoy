...
class LinkjoyAncestorArouseOverbearBloomer extends StatelessWidget {
  static final List<ChatInputFuncItem> _configItems = [];

  final ValueChanged<ChatInputFuncType>? selectFunc;

  const LinkjoyAncestorArouseOverbearBloomer({super.key, this.selectFunc});
      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Image(
              image: LinkjoyFasten.assetProvider(item.icon),
              width: 36.0,
              height: 36.0,
              fit: BoxFit.contain,
            ),
          ...
          Text(item.name, style: LinkjoyMarshaGreen.TextB3_12),
        ],
      ),
