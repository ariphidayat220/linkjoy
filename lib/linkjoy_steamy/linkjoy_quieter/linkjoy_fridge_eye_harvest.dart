...
class LinkjoyFridgeEyeHarvest extends StatefulWidget {
  const LinkjoyFridgeEyeHarvest({
    super.key,
    required this.color,
    required this.width,
  });
  ...
  @override
  State<LinkjoyFridgeEyeHarvest> createState() =>
      _LinkjoyFridgeEyeHarvestStatus();
}

class _LinkjoyFridgeEyeHarvestStatus extends State<LinkjoyFridgeEyeHarvest>
    ...
    if (!init) {
      ...
      Future.delayed(const Duration(seconds: 1), () {
        ...
        try {
          ...
          LinkjoySteamyClamOily.linkjoyInvoiceCircus(10096, e, stack);
          return;
        }
      });
    } else {
