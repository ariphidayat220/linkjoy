...
class LinkjoyFondnessStoolSaver {
  late String version;
  late String lang;
  late String appPackage;

  late String shortLang;
  ...
  LinkjoyFondnessStoolSaver();

  factory LinkjoyFondnessStoolSaver.fromJson(Map<String, dynamic> json) {
    return LinkjoyFondnessStoolSaver()
      ...
      ..vm = LinkjoySmearSister.intDef(json, "vm", 0)
      ..px_ratio = LinkjoySmearSister.doubleDef(json, "px_ratio", 0)
      ..low_mem = LinkjoySmearSister.intDef(json, "low_mem", 0)
      ..vpn = LinkjoySmearSister.intDef(json, "vpn", 0);
  }
  ...
  String get linkjoyWailUnbornBakery {
    String pkg = hex.encode(
      md5.convert(const Utf8Encoder().convert("$appPackage")).bytes,
    );
