...
class LinkjoyFondnessPassionateAdSaver {
  LinkjoyFondnessPassionateAdSaver([
    this.trackerToken,
    this.trackerName,
    this.network,
    this.campaign,
  ...
  factory LinkjoyFondnessPassionateAdSaver.fromJson(Map<String, dynamic> json) {
    return LinkjoyFondnessPassionateAdSaver(
