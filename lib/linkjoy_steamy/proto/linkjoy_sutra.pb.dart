...
import 'linkjoy_sutra.pbenum.dart';

export 'linkjoy_sutra.pbenum.dart';
...
class ChatCall extends $pb.GeneratedMessage {
  ...
  factory ChatCall({
    ...
    if (useCardType != null) {
      _result.useCardType = useCardType;
    }
    if (originPrice != null) {
  ...
  @$pb.TagNumber(22)
  $core.int get useCardType => $_getIZ(21);

  @$pb.TagNumber(22)
  set useCardType($core.int v) {
    $_setUnsignedInt32(21, v);
  }

  @$pb.TagNumber(22)
  $core.bool hasUseCardType() => $_has(21);

  @$pb.TagNumber(22)
  void clearUseCardType() => clearField(22);

  @$pb.TagNumber(23)
  $fixnum.Int64 get originPrice => $_getI64(22);
  ...
  @$pb.TagNumber(23)
  $core.bool hasOriginPrice() => $_has(22);

  @$pb.TagNumber(23)
  void clearOriginPrice() => clearField(23);
}
