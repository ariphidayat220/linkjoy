...
class Message_Type extends $pb.ProtobufEnum {
  ...
  static const Message_Type MATCH_LIKE_REQ = Message_Type._(
    2081,
    const $core.bool.fromEnvironment('protobuf.omit_enum_names')
        ? ''
        : 'MATCH_LIKE_REQ',
  );
  static const Message_Type MATCH_LIKE_RSP = Message_Type._(
    2082,
    const $core.bool.fromEnvironment('protobuf.omit_enum_names')
        ? ''
        : 'MATCH_LIKE_RSP',
  );
  static const Message_Type MATCH_LIKE_RESULT = Message_Type._(
    2083,
    const $core.bool.fromEnvironment('protobuf.omit_enum_names')
        ? ''
        : 'MATCH_LIKE_RESULT',
  );
  static const Message_Type MATCH_CALL_REQ = Message_Type._(
    2084,
    const $core.bool.fromEnvironment('protobuf.omit_enum_names')
        ? ''
        : 'MATCH_CALL_REQ',
  );
  static const Message_Type CHATCALL_MESSAGE_SEND_REQ = Message_Type._(
    2085,
    const $core.bool.fromEnvironment('protobuf.omit_enum_names')
        ? ''
        : 'CHATCALL_MESSAGE_SEND_REQ',
  );
  static const Message_Type CHATCALL_MESSAGE_SEND_PSH = Message_Type._(
    2086,
    const $core.bool.fromEnvironment('protobuf.omit_enum_names')
        ? ''
        : 'CHATCALL_MESSAGE_SEND_PSH',
  );
