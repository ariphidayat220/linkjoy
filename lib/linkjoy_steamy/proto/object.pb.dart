...
class UserInfo extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  $core.String get ucode => $_getSZ(7);
  ...
  @$pb.TagNumber(8)
  $core.bool hasUcode() => $_has(7);

  @$pb.TagNumber(8)
  void clearUcode() => clearField(8);
  ...
  @$pb.TagNumber(10)
  Country get userCountry => $_getN(9);
  ...
  @$pb.TagNumber(10)
  $core.bool hasUserCountry() => $_has(9);

  @$pb.TagNumber(10)
  void clearUserCountry() => clearField(10);

  @$pb.TagNumber(10)
  Country ensureUserCountry() => $_ensure(9);

  @$pb.TagNumber(11)
  $core.String get tagIds => $_getSZ(10);
  ...
  @$pb.TagNumber(11)
  $core.bool hasTagIds() => $_has(10);

  @$pb.TagNumber(11)
  void clearTagIds() => clearField(11);

  @$pb.TagNumber(12)
  $core.String get languages => $_getSZ(11);
  ...
  @$pb.TagNumber(12)
  $core.bool hasLanguages() => $_has(11);

  @$pb.TagNumber(12)
  void clearLanguages() => clearField(12);
